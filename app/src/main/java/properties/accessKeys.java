...
public class accessKeys {
    ...
    private static String targetLong;
    private static String targetLat;
    private static String defaultUserId;
    private static String defaultUserEmail;
    private static boolean movementMonitor;
    ...
    public static void setUserImage(String userImage) {
        accessKeys.userImage = userImage;
    }
    ...
    public static String getTargetLong() {
        return targetLong;
    }

    public static void setTargetLong(String targetLong) {
        accessKeys.targetLong = targetLong;
    }
    ...
    public static void setTargetLat(String targetLang) {
        accessKeys.targetLat = targetLang;
    }
    ...
    public static boolean isMovementMonitor() {
        return movementMonitor;
    }

    public static void setMovementMonitor(boolean movementMonitor) {
        accessKeys.movementMonitor = movementMonitor;
    }
